...
Pod::Spec.new do |s|
  s.name             = "SCRatingView"
  s.version          = "0.1.0"
  s.summary          = "A short description of SCRatingView."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/SCRatingView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "devsujith" => "dev.sujithchandran@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/SCRatingView.git", :tag => s.version.to_s }
